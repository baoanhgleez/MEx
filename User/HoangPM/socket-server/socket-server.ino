...
const char* ssid = "hoang";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
const char* password = "johncena";  //Pass mạng wifi ahihi, anh em rãnh thì share pass cho mình với.
 
char host[] = "192.168.238.1";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
