...
public class MainActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    private void initial_views() {
        ...
        vrMode = (Button) findViewById(R.id.VRMode);
        vrMode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this,VRCardBoard.class));
            }
        });
    }
